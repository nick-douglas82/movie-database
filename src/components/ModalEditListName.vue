...
const emit = defineEmits(['close', 'updateListName'])
...
const setNewListName = () => {
  open.value = false
  emit('updateListName', listName)
}
          ...
          >
            ...
            <div>
              <div class="mt-3 text-center sm:mt-5">
                <DialogTitle as="h3" class="text-lg font-medium leading-6 text-gray-900">Edit list name</DialogTitle>
                <div class="mt-2">
                  <input
                    v-model="listName"
                    type="text"
            ...
            <div class="mt-5 text-center sm:mt-6">
              <ButtonBase class="text-white" @click="setNewListName">Update List Name</ButtonBase>
            </div>
          </div>
        </TransitionChild>
      </div>
